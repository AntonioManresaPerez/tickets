  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="shrink-0 text-xs font-medium text-slate-400">#{task.id}</span>
      </div>
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        ...
        <span className="inline-flex items-center gap-1 rounded-full bg-slate-50 px-2 py-0.5 text-xs font-medium text-slate-500 ring-1 ring-inset ring-slate-200">
